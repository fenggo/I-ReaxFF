...
def get_gulp_energy(atoms,ffild='reaxff_nn'):
...
def get_gulp_force_from_drv(fdrv):
    forces = []
...
def get_gulp_forces(images,traj='gulp_force.traj',ffield='reaxff_nn'):
    ...
    for i,atoms in enumerate(images):
        write_gulp_in(atoms,runword='gradient nosymmetry conv qite verb',
                      ...
                      lib=ffield)
        system('gulp<inp-gulp>out')
        forces = get_gulp_force_from_drv('gulp.drv')
        #atoms.forces = forces
