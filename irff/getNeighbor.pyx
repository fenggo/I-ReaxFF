...
def get_neighbors(filename=None,Atoms=None,r_cut=None,cell=None,exception=[]):
    ...
    if r_cut is None:
       r_cut = {'Fe-C':2.0,'Fe-H':1.8,'Fe-N':2.0,'Fe-O':2.0,'Fe-Fe':2.2,
               'C-C':1.8,'C-N':1.8,'C-O':1.8,'C-H':1.5,
               'N-N':1.9,'N-H':1.8,'N-O':1.8,
               'O-H':1.8,'O-O':1.7,
               'H-H':1.3,
               'Cl-C':2.0,'Cl-N':2.0,'Cl-O':2.0,'Cl-H':1.7,'Cl-Fe':2.2,'Cl-Cl':2.15,
               'F-C':1.85,'F-N':1.85,'F-O':1.85,'F-H':1.7,'F-Fe':1.85,'F-Cl':1.85,'F-F':1.85,
               'other':1.8}
